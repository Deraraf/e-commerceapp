          ...
          <>
            ...
            <div>
              {product.reviews.map((review) => (
                <div
                  key={review._id}
                  className="bg-neutral-900 p-4 rounded-lg xl:ml-[2rem] sm:ml-[0rem] xl:w-[50rem] sm:w-[24rem] mb-5"
                >
                  ...
                  <Ratings
                    value={review.rating}
                    className="my-2 text-orange-400"
                  />
                </div>
              ))}
            </div>
...
ProductTabs.propTypes = {
  loadingProductReview: PropsTypes.bool.isRequired,
  userInfo: PropsTypes.bool.isRequired,
  submitHandler: PropsTypes.func.isRequired,
  rating: PropsTypes.number.isRequired,
  setRating: PropsTypes.func.isRequired,
  comment: PropsTypes.string.isRequired,
  setComment: PropsTypes.func.isRequired,
